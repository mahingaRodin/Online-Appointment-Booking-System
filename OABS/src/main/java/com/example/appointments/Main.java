...
public class Main {
    public static void main(String[] args) {
        try {
            ...
            // Add individual servlets
            tomcat.addServlet(contextPath, "HealthCheckServlet", (Servlet) new HealthCheckServlet());
            tomcat.addServlet(contextPath, "UserServlet",(Servlet) new RegisterUserServlet());
            tomcat.addServlet(contextPath, "AppointmentServlet",(Servlet) new GetAppointmentServlet());
